...
from maligaya_check_reservation import check_reservation

from models import Resident, MaligayaCourtReservationList, db
...
def resident_facilities_court1():
    ...
    tuesday_7am = check_reservation('Tuesday', '7amslot')
    tuesday_8am = check_reservation('Tuesday', '8amslot')
    tuesday_9am = check_reservation('Tuesday', '9amslot')
    tuesday_10am = check_reservation('Tuesday', '10amslot')
    tuesday_11am = check_reservation('Tuesday', '11amslot')
    tuesday_12pm = check_reservation('Tuesday', '12pmslot')
    tuesday_1pm = check_reservation('Tuesday', '1pmslot')
    tuesday_2pm = check_reservation('Tuesday', '2pmslot')
    tuesday_3pm = check_reservation('Tuesday', '3pmslot')
    tuesday_4pm = check_reservation('Tuesday', '4pmslot')
    tuesday_5pm = check_reservation('Tuesday', '5pmslot')
    tuesday_6pm = check_reservation('Tuesday', '6pmslot')

    wednesday_7am = check_reservation('Wednesday', '7amslot')
    wednesday_8am = check_reservation('Wednesday', '8amslot')
    wednesday_9am = check_reservation('Wednesday', '9amslot')
    wednesday_10am = check_reservation('Wednesday', '10amslot')
    wednesday_11am = check_reservation('Wednesday', '11amslot')
    wednesday_12pm = check_reservation('Wednesday', '12pmslot')
    wednesday_1pm = check_reservation('Wednesday', '1pmslot')
    wednesday_2pm = check_reservation('Wednesday', '2pmslot')
    wednesday_3pm = check_reservation('Wednesday', '3pmslot')
    wednesday_4pm = check_reservation('Wednesday', '4pmslot')
    wednesday_5pm = check_reservation('Wednesday', '5pmslot')
    wednesday_6pm = check_reservation('Wednesday', '6pmslot')

    thursday_7am = check_reservation('Thursday', '7amslot')
    thursday_8am = check_reservation('Thursday', '8amslot')
    thursday_9am = check_reservation('Thursday', '9amslot')
    thursday_10am = check_reservation('Thursday', '10amslot')
    thursday_11am = check_reservation('Thursday', '11amslot')
    thursday_12pm = check_reservation('Thursday', '12pmslot')
    thursday_1pm = check_reservation('Thursday', '1pmslot')
    thursday_2pm = check_reservation('Thursday', '2pmslot')
    thursday_3pm = check_reservation('Thursday', '3pmslot')
    thursday_4pm = check_reservation('Thursday', '4pmslot')
    thursday_5pm = check_reservation('Thursday', '5pmslot')
    thursday_6pm = check_reservation('Thursday', '6pmslot')

    friday_7am = check_reservation('Friday', '7amslot')
    friday_8am = check_reservation('Friday', '8amslot')
    friday_9am = check_reservation('Friday', '9amslot')
    friday_10am = check_reservation('Friday', '10amslot')
    friday_11am = check_reservation('Friday', '11amslot')
    friday_12pm = check_reservation('Friday', '12pmslot')
    friday_1pm = check_reservation('Friday', '1pmslot')
    friday_2pm = check_reservation('Friday', '2pmslot')
    friday_3pm = check_reservation('Friday', '3pmslot')
    friday_4pm = check_reservation('Friday', '4pmslot')
    friday_5pm = check_reservation('Friday', '5pmslot')
    friday_6pm = check_reservation('Friday', '6pmslot')

    saturday_7am = check_reservation('Saturday', '7amslot')
    saturday_8am = check_reservation('Saturday', '8amslot')
    saturday_9am = check_reservation('Saturday', '9amslot')
    saturday_10am = check_reservation('Saturday', '10amslot')
    saturday_11am = check_reservation('Saturday', '11amslot')
    saturday_12pm = check_reservation('Saturday', '12pmslot')
    saturday_1pm = check_reservation('Saturday', '1pmslot')
    saturday_2pm = check_reservation('Saturday', '2pmslot')
    saturday_3pm = check_reservation('Saturday', '3pmslot')
    saturday_4pm = check_reservation('Saturday', '4pmslot')
    saturday_5pm = check_reservation('Saturday', '5pmslot')
    saturday_6pm = check_reservation('Saturday', '6pmslot')

    sunday_7am = check_reservation('Sunday', '7amslot')
    sunday_8am = check_reservation('Sunday', '8amslot')
    sunday_9am = check_reservation('Sunday', '9amslot')
    sunday_10am = check_reservation('Sunday', '10amslot')
    sunday_11am = check_reservation('Sunday', '11amslot')
    sunday_12pm = check_reservation('Sunday', '12pmslot')
    sunday_1pm = check_reservation('Sunday', '1pmslot')
    sunday_2pm = check_reservation('Sunday', '2pmslot')
    sunday_3pm = check_reservation('Sunday', '3pmslot')
    sunday_4pm = check_reservation('Sunday', '4pmslot')
    sunday_5pm = check_reservation('Sunday', '5pmslot')
    sunday_6pm = check_reservation('Sunday', '6pmslot')
